...
../../build/apps/translatorator_v0.9.1 -cluster -sequences reads.bam -cds-kmers GTTAA AAAAA -range chr1:1-60 -summary - -min-fraction-per-sample 0 -min-obs-per-sample 1
